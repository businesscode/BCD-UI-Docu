...
BCD-UI provides a file with its JavaScript API. Add this to your IDE, and you will have auto-complete while editing JavaScript orTypeScript. The files can be found here: link:https://github.com/businesscode/BCD-UI-Docu/tree/master/resources[^]. +
