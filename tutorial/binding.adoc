...
Write pre- and processing:: The option to enforce additional processing of accesses to the database, for example application specific way to keep track of changes.
