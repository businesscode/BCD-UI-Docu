...
. Configuration
+
The shiro.ini link:https://github.com/businesscode/BCD-UI/blob/master/Server/configFiles/shiro.ini[template of BCD-UI] describes the setup, more about this the following section
+
.oAuth sample with Azure
[source]
----
include::../web/WEB-INF/shiro.xml[tag=oAuth,indent=0]
----
