...
WYSIWYG export into PDF and spreadsheets:: The spreadsheet export allows to further work wih the numbers. User formulas are be replaced by the calculation results.
...
<3> This are the actually applied measures
