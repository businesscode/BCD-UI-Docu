...
TIP: The import makes BCD-UI JavaScript and TypeScript API stubs available to the editor. 
The files with the subs can be downloaded here from link:https://github.com/businesscode/BCD-UI-Docu/tree/master/resources[^]
