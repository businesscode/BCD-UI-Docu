...
TIP: The import makes BCD-UI JavaScript API stubs available to the editor. It will be removed by during runtime by BCD-UI automatically and is only used during editing. They can be downloaded here from link:https://businesscode.github.io/BCD-UI-Docu/resources/bcduiApiStubs.js[bcduiApiStubs.js^]
