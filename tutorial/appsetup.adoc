...
. Copy link:https://github.com/businesscode/BCD-UI/blob/master/Server/configFiles/subjectSettings.xml[BCD-UI/Server/configFiles/subjectSettings.xml^] to `WEB-INF/bcdui`
