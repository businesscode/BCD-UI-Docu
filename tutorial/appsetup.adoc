...
. Unzip bcduiTsTypes.zip at link:https://github.com/businesscode/BCD-UI-Docu/tree/master/resources[^] into your project. +
This file allows for autocompletion of BCD-UI JavaScript classes in the IDE
+
