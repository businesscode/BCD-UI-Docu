...
| args.config | bcdui.core.DataProvider |  | The scorecard definition |
| args.id? | string |  | The id of the new object. If omitted the id is automatically generated |
| args.customParameter? | bcdui.core.DataProvider |  | Custom parameters for usage in the custom aggregator and aspect transformations.</li> |
| args.statusModel? | bcdui.core.DataProvider | bcdui.wkModels.guiStatusEstablished | StatusModel, containing the filters at /SomeRoot/f:Filter |
| args.parameters? | object |  | Custom parameters to be shared between all aggregators, aspects, etc. |
