...
| args.id? | string |  | The object's id, needed only when later accessing via id. If given the GridModel registers itself at [bcdui.factory.objectRegistry](bcdui.factory.objectRegistry.md) |
| args.statusModel? | bcdui.core.DataProvider | bcdui.wkModels.guiStatusEstablished | StatusModel, containing the filters as /SomeRoot/f:Filter |
| args.saveChain? | chainDef |  | The definition of the transformation chain |
| args.saveParameters? | Object |  | An object, where each property holds a DataProvider, used as a transformation parameters. |
| args.validationChain? | chainDef |  | The definition of the transformation chain |
| args.validationParameters? | Object |  | An object, where each property holds a DataProvider, used as a transformation parameters. |
| args.loadChain? | chainDef |  | The definition of the transformation chain |
| args.loadParameters? | Object |  | An object, where each property holds a DataProvider, used as a transformation parameters. |
| args.serverSidedPagination? | Object | false | Set to true if you want to enable server sided pagination |
| args.pagerModel? | bcdui.core.DataProvider | bcdui.wkModels.guiStatus | StatusModel of the pagination information |
...
_Overrides_ bcdui.core.SimpleModel#tblGetColumnMetadata
...
_Overrides_ bcdui.core.SimpleModel#tblGetRowIds
...
_Overrides_ bcdui.core.SimpleModel#tblValidateRowChange
