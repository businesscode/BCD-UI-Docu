...
| args.generateItemHtmlSource? | function |  | Function to generate the html for the source container item. Gets object with properties: value, caption, position; see implementation documentation to read more about the structure to return by this function. |
