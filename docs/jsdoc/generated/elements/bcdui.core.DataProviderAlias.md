...
|----------|----------|----------|-------------|
| args | object |  | The argument map taking two mandatory parameters: |
| args.source | bcdui.core.DataProvider |  | The data provider to be wrapped |
| args.name | string |  | The new name of the data provider |
