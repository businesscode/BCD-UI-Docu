...
|----------|----------|----------|-------------|
| args | object |  |  |
| args.optionsModelXPath | modelXPath |  | Data xPath with model reference, like <code>"$modelId/guiStatus:MyNode/@myAttr"</code>,<br/>                                                                       is treated as value+caption in case args.optionsModelRelativeValueXPath is NOT DEFINED or<br/>                                                                       is treated as value only in case args.optionsModelRelativeValueXPath IS DEFINED. |
| args.optionsModelRelativeValueXPath? | xPath |  | optional xPath relative to args.optionsModelXPath |
