...
| args.callback | function |  | The callback providing the data; gets args object with 'setData' function to call once data is available. |
| args.id? | string |  | A globally unique id for use in declarative contexts |
