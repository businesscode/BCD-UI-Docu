# Class RequestDocumentDataProvider
package bcdui.core
...
| args.requestModel? | bcdui.core.DataProvider |  | A DataProvider providing a request, for example a wrs:WrsRequest |
| args.url? | string |  | URL to load the data from, use this or args.requestModel. |
| args.modelUrl? | (string\|bcdui.core.DataProvider) | 'WrsServlet' | When using args.requestModel, this is a string or string- DataProvider with the URL which to send the requestModel result to |
| args.uri? | string |  | uri extension as a suffix to .url to tag requests, must not start with '/'. This parameter is ineffective if .modelUrl or .url is provided. |
| args.id? | string |  | Globally unique id for use in declarative contexts |
| args.isAutoRefresh? | boolean | false | If true, this DataProvider will always update itself when the requestDoc changes (without the need for execute) and fire a data modification event<br/>                                                                         If used as a urlProvider from a [SimpleModel](bcdui.core.SimpleModel.md), it inherits its isAutoRefresh |
| args.attachSessionHash? | boolean | false | Logical name of this DataProvider when used as a parameter in a transformation |
| args.name? | string |  | Logical name of this DataProvider when used as a parameter in a transformation, locally unique |
| args.method? | string | "GET" | Request method for SimpleModel, either "POST" or "GET" |
...
### setIsAutoRefresh
setIsAutoRefresh(isAutoRefresh) &#x21FE; {void}
...
_Overrides_ bcdui.core.DataProvider#tblGetColumnMetadata
...
_Overrides_ bcdui.core.DataProvider#tblGetRowIds
...
_Overrides_ bcdui.core.DataProvider#tblValidateRowChange
