...
<span hidden class='htmlPackage'>bcdui.component.textnavigation</span>
...
### singleDigitToWord
<span style='display: none; font-size: 0.75em' class='htmlSignature' data-id='+docu.name'>(text, prefix) &#x21FE; {string}</span>
