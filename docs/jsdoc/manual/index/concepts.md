...
See [Project Setup](/manual/elements/projectSetup.md) for the required file and directory structure of a BCD-UI project.
...
Extensive industry-level security and support for multi-tenant environment are provided by BCD-UI.
This applies to UI as well as to data.

See [Project Setup](/manual/elements/projectSetup.md) for initial easy setup and [Security](/manual/elements/security.md) for more details.
